    ...
    <div id="root">
        <div class="App">
            ...
            <div class="List-Product" id="List-Product">
                <div class="Product">
                    <h4>izi Jr</h4><img src="https://www.izipay.pe/_nuxt/dist/img/agente-izipay-large.74b5825.png" alt="izi Jr">
                    <input type="hidden" id="amount" value="90">
                    <p><span>S/</span>90</p><button>Comprar</button>
                </div>
                <div class="Product">
                    <h4>izi android</h4><img src="https://www.izipay.pe/_nuxt/dist/img/agente-izipay-large.74b5825.png" alt="izi android">
                    <input type="hidden" id="amount" value="100">
                    <p><span>S/</span>100</p><button>Comprar</button>
                </div>
                <div class="Product">
                    <h4>Gestiona tu negocio</h4><img src="https://www.izipay.pe/_nuxt/dist/img/agente-izipay-large.74b5825.png" alt="Gestiona tu negocio">
                        ...
                        <div class='checkout'>
                            ...
                            <form id='form-control' method='post'> 
                                ...
                                <div class='control-group'>
                                    <label for='firstname' style='top:-5px, font-size: 12px;'>First Name</label>
                                    <input type'text' id='firstname' name='firstname' autocomplete='off' required='' value=''>
                                </div>
                                <div class='control-group'>
                                    <label for='lastname' style='top:-5px, font-size: 12px;'>Last Name</label>
                                    <input type'text' id='lastname' name='lastname' autocomplete='off' required='' value=''>
                                </div>
                                <div class='control-group'>
                                    <label for='email' style='top:-5px, font-size: 12px;'>Email</label>
